...
def train_student(dataloader, cur_epoch, teacher_model=None, logging_interval=10, tensorboard_writer=None):
    '''
    ...
    for step, batch in enumerate(dataloader, 1):
        ...
        if teacher_model is not None:
            batch['labels'] = teacher_model(**batch).logits.to(device)
...
def eval_student(dataloader, cur_epoch, logging_interval=10, tensorboard_writer=None):
